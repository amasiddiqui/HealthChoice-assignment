...
void 0,b?b.onError:void 0,e,function(){var a=new ReadableStream({type:"bytes",pull:function(a){if(1===k.status)k.status=2,Ga(a,k.fatalError);else if(2!==k.status&&null===k.destination){k.destination=a;try{Aa(k,a)}catch(Sa){S(k,Sa),ea(k,Sa)}}},cancel:function(a){Bb(k)}},{highWaterMark:0});a.allReady=g;c(a)},function(a){g.catch(function(){});d(a)},f);if(b&&b.signal){var l=b.signal,n=function(){Bb(k,l.reason);l.removeEventListener("abort",n)};l.addEventListener("abort",n)}pb(k)})};I.version="18.2.0"});
=======
