      ...
      <Grid container spacing={1}>
        ...
        <Grid item xs={2}>
            <Grid container direction="column" spacing={1}>
              ...
              <span className={classes.inlineText}>
                <strong>Health</strong>Choice<sup><small>TM</small></sup>
              </span>
            </Typography>
              </Button>
              </Grid>
        ...
        <Grid item xs={1.5}>
            <Grid container spacing={0} alignItems="center">
              <Grid item>
                <FacebookIcon  style={{ padding:'2px', color: 'white', fontSize:'25px'}}/>
                <Twitter  style={{ padding:'2px', color: 'white', fontSize:'25px'}}/>
                <YouTube  style={{ padding:'2px', color: 'white', fontSize:'25px'}}/>
              </Grid>
            </Grid>
          </Grid>
          {/* icons code end */}
        ...
        <Grid item xs={2.05}>
            <Grid container direction="column" spacing={1}>
              <Grid item>
              <Button className={classes.customButton} variant="Text" style={{ textTransform: 'none', color: 'white'}}>
              Customer Resources
              </Button>
              </Grid>
              <Grid item>
